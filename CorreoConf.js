...
export default function Prev({volverHome}){
    const SvgComponent = () => (
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <Text style={styles.titulo}>Enviamos un correo</Text>
            <Text style={styles.sub1}>En breve te llegará un código con el cúal podrás reestablecer tu cuenta</Text>
            <Text style={styles.titulo2}>Ingresa el código:</Text>
            <StatusBar style="auto" />
            <TextInput style={styles.inp1} placeholder='Ejemplo: 123345'></TextInput>
