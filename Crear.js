...
export default function Prev({volverHome,fun33}){
    const SvgComponent = () => (
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <TextInput style={styles.inp1} placeholder='Confirmar contraseña'></TextInput>
            <TouchableOpacity onPress={fun33} style={styles.contBot} >
                <LinearGradient  style={styles.button} colors={['#FF6868','#FFBB64','#FFEAA7']} start={{x: 0,y: 0}}>
                    <Text style={styles.sub2}>Confirmar</Text>
                </LinearGradient>
            </TouchableOpacity>
            <Text style={styles.sub5}>¿Ya tienes cuenta? </Text>
