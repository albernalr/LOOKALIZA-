...
export default function Prev({fun2,fun21,fun22}){
    const SvgComponent = () => (
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <Text style={styles.sub1}>Ingresa a tu cuenta</Text>
            <StatusBar style="auto" />
            <TextInput style={styles.inp1} placeholder='Correo'></TextInput>
            <TextInput style={styles.inp1} placeholder='Contraseña'></TextInput>
            <TouchableOpacity  onPress={fun22} style={styles.prueb1} >
                <Text style={styles.sub3}> Olvidé mi contraseña</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={fun2} style={styles.contBot} >
                <LinearGradient style={styles.button} colors={['#FF6868','#FFBB64','#FFEAA7']} start={{x: 0,y: 0}}>
                    <Text style={styles.sub2}>Ingresar</Text>
                </LinearGradient>
            </TouchableOpacity>
            <Text style={styles.sub5}>¿No tienes una cuenta? </Text>
