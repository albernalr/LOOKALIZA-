...
export default function Prev({fun41}){
    const SvgComponent = () => (
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <Text style={styles.sub1}>Antes de empezar:</Text>
            <Text style={styles.sub1}>Habilite las notificaciones para estar al dia con nuestras recomendaciones</Text>
            <View style={styles.sub7}></View>
            <StatusBar style="auto" />
            {/* <TouchableOpacity  onPress={} style={styles.prueb1} >
                <Text style={styles.sub3}> Olvidé mi contraseña</Text>
            </TouchableOpacity> */}
            <Icon  name="notifications" size={90} color="#000" style={styles.icono} />
            <TouchableOpacity onPress={fun41} style={styles.contBot} >
                <LinearGradient style={styles.button} colors={['#FF6868','#FFBB64','#FFEAA7']} start={{x: 0,y: 0}}>
                    <Text style={styles.sub2}>Aceptar</Text>
                </LinearGradient>
            </TouchableOpacity>
            <Text style={styles.sub5}>Continuar sin aceptar </Text>
            {/* <TouchableOpacity style={styles.prueb1} onPress={fun21}>
                <Text style={styles.sub4}> ¡Regístrate! </Text>
            </TouchableOpacity> */}
